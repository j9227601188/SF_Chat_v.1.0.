...
Реализация: класс Message для сообщений, User для пользователей, Chat с вектором сообщений, пользователеей и реализацией всего функционала, все с родительскими классами (для гибкости дальнейшего развития программы).
...
Implementation: Message class for messages, User for users, Chat with message vector, user and implementation of all functionality, all with parent classes (for flexibility of further development of the program).
